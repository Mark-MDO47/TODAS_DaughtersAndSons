...
#    input filename list in desired order
#      filenames are of form anything.wav
#    output file in .bat or .sh format
#      copies and renames files to FAT32 formatted drive
